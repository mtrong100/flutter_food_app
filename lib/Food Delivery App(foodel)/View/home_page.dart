...
import 'package:flutter_food_app/Food%20Delivery%20App(foodel)/View/product_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    if (myCategories.isNotEmpty) {
      category =
          myCategories[0].name; //Kiểm tra trường hợp khi chưa chọn category
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text(
                "Hãy tìm những món ăn ngon nhất xung quanh bạn",
                style: TextStyle(
                  color: kblack,
                  letterSpacing: -.4,
                  fontSize: 34,
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 30),
              child: Text(
                'Kết quả tìm thấy: (${productModel.length})',
                style: TextStyle(
